          ...
          <div class="tags">
            <div class="example-one-header scroll">
              ...
              <nav class="vertical-align-middle">
                ...
                <a href="<?php bloginfo('url'); ?>/service/experience-design" class="nav-item"><span class="circle">○</span>Experience Design</a>
                <a href="<?php bloginfo('url'); ?>/service/development" class="nav-item selected"><span class="circle">●</span>Development</a>
              </nav>
            </div>
          </div>
        </div><!-- Tags end -->
