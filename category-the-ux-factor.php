          ...
          <div class="tags">
            <div class="example-one-header scroll">
              ...
              <nav class="vertical-align-middle">
                <a href="<?php bloginfo('url'); ?>/the-ux-factor" class="nav-item selected"><span class="circle">●</span>All Insights</a>
                ...
                <a href="<?php bloginfo('url'); ?>/tag/development" class="nav-item"><span class="circle">○</span>Development</a>
